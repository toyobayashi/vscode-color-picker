(function (global, factory) {
    ...
    exports.ColorPicker = /** @class */ (function () {
        function ColorPicker(container, color, pixelRatio) {
            ...
            var label = ColorPicker.formatColor(colorInstance, ColorPicker.ColorType.RGB);
            ...
            this._model.onDidChangeColor(function (e) {
                for (var i = 0; i < _this._model.colorPresentations.length; i++) {
                    _this._model.colorPresentations[i].label = ColorPicker.formatColor(e, i + 1);
                }
            });
