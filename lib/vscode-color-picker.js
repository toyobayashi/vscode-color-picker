(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.vscodeColorPicker = {}));
    ...
    var ColorPickerHeader = /** @class */ (function (_super) {
        ...
        function ColorPickerHeader(container, model) {
            ...
            colorBox.style.backgroundColor = exports.Color.Format.CSS.format(_this.model.originalColor) || '';
            _this.backgroundColor = exports.Color.white;
            ...
            _this.pickedColorNode.style.backgroundColor = exports.Color.Format.CSS.format(model.color) || '';
        ...
        ColorPickerHeader.prototype.onDidChangeColor = function (color) {
            this.pickedColorNode.style.backgroundColor = exports.Color.Format.CSS.format(color) || '';
    ...
    var ColorPickerBody = /** @class */ (function (_super) {
        ...
        ColorPickerBody.prototype.onDidSaturationValueChange = function (_a) {
            ...
            this.model.color = new exports.Color(new HSVA(hsva.h, s, v, hsva.a));
        };
        ColorPickerBody.prototype.onDidOpacityChange = function (a) {
            var hsva = this.model.color.hsva;
            this.model.color = new exports.Color(new HSVA(hsva.h, hsva.s, hsva.v, a));
        };
        ColorPickerBody.prototype.onDidHueChange = function (value) {
            var hsva = this.model.color.hsva;
            var h = (1 - value) * 360;
            this.model.color = new exports.Color(new HSVA(h === 360 ? 0 : h, hsva.s, hsva.v, hsva.a));
        };
    ...
    var SaturationBox = /** @class */ (function (_super) {
        ...
        SaturationBox.prototype.paint = function () {
            var hsva = this.model.color.hsva;
            var saturatedColor = new exports.Color(new HSVA(hsva.h, 1, 1, 1));
            ...
            ctx.fillStyle = exports.Color.Format.CSS.format(saturatedColor);
            ctx.fill();
    ...
    var OpacityStrip = /** @class */ (function (_super) {
        ...
        OpacityStrip.prototype.onDidChangeColor = function (color) {
            ...
            var opaque = new exports.Color(new RGBA(r, g, b, 1));
            var transparent = new exports.Color(new RGBA(r, g, b, 0));
    ...
    exports.ColorPicker = /** @class */ (function () {
        function ColorPicker(container, props) {
            ...
            var presentations = (_b = _props.presentations) !== null && _b !== void 0 ? _b : [];
            var presentationIndex = (_c = _props.presentationIndex) !== null && _c !== void 0 ? _c : 0;
            var pixelRatio = (_d = _props.pixelRatio) !== null && _d !== void 0 ? _d : 1;
            ...
            //   }
            // })
            this._model.onColorFlushed(function () {
        ...
        ColorPicker.toColor = function (color) {
            if (color instanceof exports.Color) {
                return color;
            }
            ...
            if (c.charCodeAt(0) === 35 /* Hash */) {
                return exports.Color.fromHex(c);
            }
            else if (matches = c.match(/^rgb\(\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*,\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*,\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*\)$/)) {
                return new exports.Color(new RGBA(Number(matches[1]), Number(matches[2]), Number(matches[3])));
            }
            else if (matches = c.match(/^rgba\(\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*,\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*,\s*([0-9]|[1-9][0-9]|[12][0-9][0-9])\s*,\s*([01](\.[0-9]+)?)\s*\)$/)) {
                return new exports.Color(new RGBA(Number(matches[1]), Number(matches[2]), Number(matches[3]), Number(matches[4])));
            }
            else if (matches = c.match(/^hsl\(\s*([0-9]|[1-9][0-9]|[123][0-9][0-9])\s*,\s*([01](\.[0-9]+)?)\s*,\s*([01](\.[0-9]+)?)\s*\)$/)) {
                return new exports.Color(new HSLA(Number(matches[1]), Number(matches[2]), Number(matches[3]), 1));
            }
            else if (matches = c.match(/^hsla\(\s*([0-9]|[1-9][0-9]|[123][0-9][0-9])\s*,\s*([01](\.[0-9]+)?)\s*,\s*([01](\.[0-9]+)?)\s*,\s*([01](\.[0-9]+)?)\s*\)$/)) {
                return new exports.Color(new HSLA(Number(matches[1]), Number(matches[2]), Number(matches[3]), Number(matches[4])));
            }
            else {
                ThrowInvalidColor(color);
            }
        ...
        ColorPicker.formatColor = function (color, type) {
            ...
            switch (type) {
                ...
                case ColorPicker.ColorType.RGB: return color.isOpaque() ? exports.Color.Format.CSS.formatRGB(color) : exports.Color.Format.CSS.formatRGBA(color);
                case ColorPicker.ColorType.HEX: return color.isOpaque() ? exports.Color.Format.CSS.formatHex(color) : exports.Color.Format.CSS.formatHexA(color);
                case ColorPicker.ColorType.HSL: return color.isOpaque() ? exports.Color.Format.CSS.formatHSL(color) : exports.Color.Format.CSS.formatHSLA(color);
                default: return '';
            }
        };
        ...
        ColorPicker.prototype.getPresentations = function () {
            return this._model.colorPresentations;
        };
        ColorPicker.prototype.setPresentations = function (presentations) {
            this._model.colorPresentations = presentations;
        };
        ColorPicker.prototype.getPresentationIndex = function () {
            return this._model.presentationIndex;
        };
        ColorPicker.prototype.setPresentationIndex = function (index) {
            if (index === this._model.presentationIndex)
                return;
            ...
            if (index > this._model.colorPresentations.length - 1 || index < 0) {
                this._model.presentationIndex = 0;
            }
            else {
                this._model.presentationIndex = index;
            }
            this._model._onDidChangePresentation.fire(this._model.presentation);
        };
        ...
        ColorPicker.prototype.setOriginalColor = function (color) {
            var colorBox = document.getElementsByClassName('original-color')[0];
            if (colorBox === undefined) {
                return;
            }
            this._model.originalColor = ColorPicker.toColor(color);
            colorBox.style.backgroundColor = exports.Color.Format.CSS.format(this._model.originalColor) || '';
        };
        ColorPicker.prototype.onColorChanged = function (listener, thisArg) {
            this._model.onDidChangeColor(listener, thisArg);
        };
        ColorPicker.prototype.onColorFlushed = function (listener, thisArg) {
            this._model.onColorFlushed(listener, thisArg);
        };
        ColorPicker.prototype.onPresentationChanged = function (listener, thisArg) {
    ...
    })(exports.ColorPicker || (exports.ColorPicker = {}));
