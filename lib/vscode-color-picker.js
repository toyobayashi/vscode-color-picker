(function (global, factory) {
    ...
    exports.ColorPicker = /** @class */ (function () {
        function ColorPicker(container, color, pixelRatio) {
            var _this = this;
            if (color === void 0) { color = '#0000'; }
            if (pixelRatio === void 0) { pixelRatio = 1; }
            this._formatTypes = [1, 2, 3];
            this._formatIndex = this._formatTypes.length - 1;
            if (typeof color === 'string') {
                color = color.trim();
            }
            var colorInstance = ColorPicker.toColor(color);
            var label = ColorPicker.formatColor(colorInstance, this._formatTypes[this._formatIndex]);
            this._model = new ColorPickerModel(colorInstance, [{ label: label }], 0);
            this._model.onDidChangeColor(function (e) {
                _this._model.presentation.label = ColorPicker.formatColor(e, _this._formatTypes[_this._formatIndex]);
            });
            this._model.onColorFlushed(function () {
                _this._widget.body.layout();
            });
            this._model.onDidChangePresentation(function () {
                _this._formatIndex = (_this._formatIndex + 1) % _this._formatTypes.length;
                _this._model.presentation.label = ColorPicker.formatColor(_this._model.color, _this._formatTypes[_this._formatIndex]);
            });
        ...
        ColorPicker.toColor = function (color) {
            ...
            var matches;
            if (color.charCodeAt(0) === 35 /* Hash */) {
                return exports.Color.fromHex(color);
            }
