...
export class ColorPickerHeader extends Disposable {
	...
	constructor(container: HTMLElement, private readonly model: ColorPickerModel) {
		super();
...
export class ColorPickerWidget extends Disposable {
	...
	constructor(container: Node, private readonly model: ColorPickerModel, private pixelRatio: number) {
		super();
